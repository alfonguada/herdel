...
document.addEventListener('DOMContentLoaded', function() {
  ...
  var messagesNavLink = document.querySelector('a[data-bs-toggle="tab"][aria-selected="false"][role="tab"]');
  var datosRedesFormulario = document.getElementById('datosRedesFormulario');

  // Agregar evento de clic al enlace de mensajes
  messagesNavLink.addEventListener('click', function() {
    // Mostrar el formulario de datos de redes sociales
    datosRedesFormulario.style.display = 'block';
  });
});
document.addEventListener('DOMContentLoaded', function() {
  var messagesNavLink = document.querySelector('a[data-bs-toggle="tab"][aria-selected="false"][role="tab"]');
  var formularioGuardarDatos = document.getElementById('formularioGuardarDatos');

  messagesNavLink.addEventListener('click', function() {
    formularioGuardarDatos.style.display = 'none';
  });
});