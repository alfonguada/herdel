...
Revision ID: 05c2d13c8d0a
Revises: c1bbbaa88980
Create Date: 2025-12-18 16:26:04.415190
...
revision = '05c2d13c8d0a'
down_revision = 'c1bbbaa88980'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(['user_id'], ['user.id'], name='fk_qr_user'),
        sa.ForeignKeyConstraint(
            ['centro_trabajo_id'],
            ['centro_trabajo.id'],
            name='fk_qr_centro_trabajo'
        ),
        sa.PrimaryKeyConstraint('id')
    )
    ...
    # ⚠️ SQLite-safe: empresa_id debe ser nullable
